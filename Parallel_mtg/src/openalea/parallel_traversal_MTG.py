...
def distributed_mtg_traversal(g,algo,direction,c_pu,func,t_size=0,alpha=0.4):
    ...
    if rank == 0:
        ...
        algos = [Best_Fit_Clustering_Paper_MTG,First_Fit_Clustering_Paper_MTG,Best_Fit_Clustering_Queue_1,Best_Fit_Clustering_level_order,First_Fit_Clustering_level_order,Best_Fit_Clustering_Paper_MTG,First_Fit_Clustering_Paper_MTG,Best_Fit_Clustering_post_order_MTG,Best_Fit_Clustering_level_order_MTG]
        start = MPI.Wtime()
        if algo in algos:
