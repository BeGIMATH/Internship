...
def plot_clusters(g, properties=None, selection=None, hlayout=True,buttons=False, scale=None,nb_cluster=None, labels=None,file_name = None, **kwds):
    """Plot an MTG at the highest scale with nodes colored based on the cluster they belong to"""
...
def plot_clusters_dependency(g, properties=None, selection=None, hlayout=True,buttons=False, scale=None,nb_cluster=None,file_name = None, labels=None, **kwds):
