...
rects1 = ax.bar(x - width, best_fit_paper_100000_up,width/4,label='Algo_1-best-fit-bottom-up')
rects2 = ax.bar(x - 3*width/4, best_fit_paper_100000_down,width/4,label='Algo_1-best-fit-top-down')
rects3 = ax.bar(x - width/2, first_fit_paper_100000_up,width/4,label='Algo_1-first-fit-bottom-up')
rects4 = ax.bar(x - width/4, first_fit_paper_100000_down,width/4,label='Algo_1-first-fit-top-down')
rects5 = ax.bar(x , best_fit_queue_100000_up,width/4,label='Algo_2-bottom-up')
rects6 = ax.bar(x + width/4, best_fit_queue_100000_down,width/4,label='Algo_2-top-down')
rects7 = ax.bar(x + width/2, best_fit_level_100000_up,width/4,label='Algo_3-bottom-up')
rects8 = ax.bar(x + 3*width/4, best_fit_level_100000_down,width/4,label='Algo_3-top-down')
...
ax.set_title('Running time for a tree with 100000 nodes')
ax.set_xticks(x)
